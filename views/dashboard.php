   ...
   <div class="login">
    <ul>
        <li class="input-text-wrap">
                <label for="direccion"><?=esc_html(__("Link address (URL)","logueo"))?></label>
        ...
        <li class="input-text-wrap">
                <label for="texto"><?=esc_html(__("Link text","logueo"))?></label>
        ...
        <li>
                <label class="input-text-wrap" for="image_url"><?=esc_html(__('Image','logueo'))?></label> 
        ...
        <li class="input-checkbox-wrap">
                <ul>
                        <li>
                                ...
                                <input  id="login_errors" type="checkbox" <?=$this->options->login_errors===1?"checked":""?>  name="login_errors" ><?=esc_html(__("Hide login errors","logueo"))?></label>
                        </li>
                        <li>
                                <label for="css_webferrol">
                                <input  id="css_webferrol" type="checkbox" <?=$this->options->css_webferrol===1?"checked":""?>  name="css_webferrol" ><?=esc_html(__("CSS WebFerrol","logueo"))?></label>
                        </li>
                </ul>
        </li>       
    </ul>
